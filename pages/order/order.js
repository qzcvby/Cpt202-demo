...
Page({
  ...
  */
  ...
  alreadyShow: function(){
    this.setData({
      alreadyOrder: [{ name: "足球场一号", state: "交易成功", time: "2021-09-30 14:00-16:00", status: "已结束", url: "../../images/bad0.png", money: "132" }, { name: "足球场一号", state: "交易成功", time: "2021-10-12 18:00-20:00", status: "未开始", url: "../../images/bad3.jpg", money: "205" }]
    })
  },
